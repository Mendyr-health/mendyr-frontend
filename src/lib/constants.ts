...
export const APP_DESCRIPTION = "Connecting patients with verified nurses and caregivers for at-home healthcare services.";
...
export const ROLE_HIERARCHY: Record<string, number> = {
  SUPER_ADMIN: 0, ADMIN: 1, NURSE: 2, PATIENT: 3,
};

export const PERMISSIONS = {
  USER_CREATE: "user:create", USER_READ: "user:read", USER_UPDATE: "user:update", USER_DELETE: "user:delete",
  NURSE_READ: "nurse:read", NURSE_UPDATE: "nurse:update", NURSE_APPROVE: "nurse:approve", NURSE_REJECT: "nurse:reject",
  PATIENT_READ: "patient:read", PATIENT_UPDATE: "patient:update",
  SERVICE_CREATE: "service:create", SERVICE_READ: "service:read", SERVICE_UPDATE: "service:update", SERVICE_DELETE: "service:delete",
  CONTACT_READ: "contact:read", CONTACT_UPDATE: "contact:update",
  WAITLIST_READ: "waitlist:read", WAITLIST_UPDATE: "waitlist:update", WAITLIST_EXPORT: "waitlist:export",
  ADMIN_CREATE: "admin:create", ADMIN_READ: "admin:read", ADMIN_UPDATE: "admin:update", ADMIN_SUSPEND: "admin:suspend",
  ROLE_CREATE: "role:create", ROLE_READ: "role:read", ROLE_UPDATE: "role:update", ROLE_DELETE: "role:delete",
...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  ADMIN: [
    PERMISSIONS.NURSE_READ, PERMISSIONS.NURSE_UPDATE, PERMISSIONS.NURSE_APPROVE, PERMISSIONS.NURSE_REJECT,
    PERMISSIONS.PATIENT_READ, PERMISSIONS.PATIENT_UPDATE,
    PERMISSIONS.SERVICE_CREATE, PERMISSIONS.SERVICE_READ, PERMISSIONS.SERVICE_UPDATE, PERMISSIONS.SERVICE_DELETE,
    PERMISSIONS.CONTACT_READ, PERMISSIONS.CONTACT_UPDATE,
    PERMISSIONS.WAITLIST_READ, PERMISSIONS.WAITLIST_UPDATE, PERMISSIONS.WAITLIST_EXPORT, PERMISSIONS.AUDIT_READ,
  ],
...
export const HEALTHCARE_SERVICES = [
  {
    ...
    icon: "Heart",
    features: ["24/7 nursing care availability", "Wound care and dressing", "IV therapy and injections", "Vital signs monitoring", "Medication management", "Post-surgical care"],
    pricingRange: "₹800 – ₹3,000/day",
  },
  {
    name: "Elder Care Support", slug: "elder-care-support",
    ...
    icon: "Users",
    features: ["Daily living assistance", "Companionship and emotional support", "Mobility assistance", "Meal preparation and nutrition", "Hygiene and personal care", "Fall prevention and safety"],
  ...
  },
  {
    ...
    icon: "Activity",
    features: ["Post-surgical rehabilitation", "Chronic pain management", "Stroke recovery programs", "Sports injury treatment", "Mobility and strength training", "Home exercise programs"],
  ...
  },
  {
    ...
    icon: "Stethoscope",
    features: ["Surgical wound management", "Pain monitoring and management", "Complication prevention", "Mobility rehabilitation", "Nutrition and diet guidance", "Doctor coordination"],
  ...
  },
  {
    ...
    icon: "Wrench",
    features: ["Hospital beds and mattresses", "Oxygen concentrators", "Wheelchairs and walkers", "Patient monitors", "Nebulizers and CPAP machines", "Delivery and setup included"],
    pricingRange: "₹500 – ₹5,000/month",
  },
  {
    name: "Emergency Assistance", slug: "emergency-assistance",
    ...
    icon: "AlertTriangle",
    features: ["Rapid response team", "First aid and stabilization", "Emergency vitals assessment", "Hospital transfer coordination", "24/7 helpline access", "Critical care nurse dispatch"],
...
export const FAQ_ITEMS = [
  { question: "When will Mendyr launch its services?", answer: "We are currently in our pre-launch phase and expect to begin full operations within the next 2–3 months. Sign up for our waitlist to be the first to know when we go live!" },
  { question: "How can I register as a patient?", answer: "You can register by clicking the 'Get Started' button and filling out the patient registration form. Once registered, you'll be added to our waitlist and notified when services become available in your area." },
  { question: "How does Mendyr verify its nurses?", answer: "Every nurse on our platform undergoes a thorough verification process including background checks, credential verification, Aadhaar verification, and experience validation. Only approved nurses can provide services through Mendyr." },
  { question: "What areas do you serve?", answer: "At launch, Mendyr will be available in select metropolitan areas. We are rapidly expanding our coverage. Join the waitlist to let us know your location and we'll prioritize areas with the highest demand." },
