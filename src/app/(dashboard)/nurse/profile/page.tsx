  ...
  return (
    <div className="space-y-8 pt-8 lg:pt-0">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-2xl font-bold text-neutral-100 font-outfit">Profile</h1>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold text-muted-foreground">{user?.fullName || "Nurse"}</h2>
              <span className="text-xs text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-full">Nurse</span>
            </div>
          </div>
      ...
      >
        ...
        <div className="space-y-4">
          <div>
            ...
            {editing ? <Input placeholder="e.g. 5 years in critical care" /> : <p className="text-sm text-muted-foreground">Not set</p>}
          </div>
          <div>
            <label className="text-xs text-muted-foreground mb-1 block">Qualifications</label>
            {editing ? <Input placeholder="e.g. B.Sc Nursing, GNM" /> : <p className="text-sm text-muted-foreground">Not set</p>}
          </div>
          <div>
            <label className="text-xs text-muted-foreground mb-1 block">Certifications</label>
            {editing ? <Input placeholder="e.g. BLS, ACLS" /> : <p className="text-sm text-muted-foreground">Not set</p>}
          </div>
        </div>
      </motion.div>
    </div>
