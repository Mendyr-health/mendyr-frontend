...
export const patientRegisterSchema = patientRegisterStep1Schema.concat(patientRegisterStep2Schema);
...
export const nurseRegisterSchema = nurseRegisterStep1Schema.concat(nurseRegisterStep2Schema);
