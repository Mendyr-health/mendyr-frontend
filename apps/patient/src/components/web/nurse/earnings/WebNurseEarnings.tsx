      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
        {[
          ...
          <motion.div
            ...
            className="bg-glass border-border hover:border-primary/50 group flex h-full flex-col justify-between rounded-2xl border p-4 transition-all sm:p-6"
          >
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground text-[10px] font-bold tracking-wider uppercase sm:text-xs">
                {card.title}
              </span>
              <div className={`rounded-xl border p-1.5 sm:p-2.5 ${card.bg}`}>
                <card.icon className={`h-3.5 w-3.5 sm:h-5 sm:w-5 ${card.color}`} />
              </div>
            </div>
            <div className="mt-3 sm:mt-4">
              <div className="text-foreground font-outfit group-hover:text-primary text-xl font-black transition-colors sm:text-3xl">
                {card.amount}
              </div>
