...
export default function WebNurseMessages() {
  ...
  return (
    <div className="space-y-6 pt-8 lg:pt-0">
      ...
      {/* Main Chat Grid */}
      <div className="bg-glass border-border relative grid h-[calc(100vh-200px)] min-h-[600px] grid-cols-1 gap-0 overflow-hidden rounded-3xl border shadow-2xl lg:h-[720px] lg:grid-cols-12 lg:gap-6">
        {/* Left Sidebar: Thread List (4 cols) */}
        <div
          className={`border-border bg-card/40 h-full flex-col border-r lg:col-span-4 ${showMobileChat ? 'hidden lg:flex' : 'flex'}`}
        >
        ...
        <div
          className={`bg-card/20 h-full flex-col lg:col-span-8 ${showMobileChat ? 'flex' : 'hidden lg:flex'}`}
        >
          {/* Thread Header */}
          <div className="border-border bg-glass flex shrink-0 items-center justify-between border-b p-4 px-4 md:px-6">
            <div className="flex items-center gap-2 md:gap-3">
              <button
                onClick={() => setShowMobileChat(false)}
                className="text-muted-foreground hover:bg-muted/50 -ml-2 rounded-xl p-2 transition-colors lg:hidden"
              >
                <ChevronLeft className="h-6 w-6" />
              </button>
              <div className="bg-primary/20 text-primary flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl text-base font-bold md:h-11 md:w-11">
          ...
          <div className="border-border bg-glass shrink-0 border-t p-4">
            ...
            >
              ...
              <Button
                ...
                className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-primary/20 h-12 shrink-0 gap-2 rounded-xl px-4 font-semibold shadow-lg md:px-6"
              >
