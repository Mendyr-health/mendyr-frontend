  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={handleExport} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-primary text-white text-sm font-medium hover:opacity-90">
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-white/5">
              {loading ? (
                ...
                <tr><td colSpan={6} className="px-4 py-12 text-center text-sm text-muted-foreground">No entries found</td></tr>
              ) : (
                entries.map((e) => (
